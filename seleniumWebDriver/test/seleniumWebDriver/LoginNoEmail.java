...
public class LoginNoEmail {
  ...
  public void testLoginNoEmail() throws Exception {
    ...
    assertEquals("The Email field is required.", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password'])[1]/preceding::span[1]")).getText());
  }

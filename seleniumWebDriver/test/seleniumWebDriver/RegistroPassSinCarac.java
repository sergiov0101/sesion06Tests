...
public class RegistroPassSinCarac {
  ...
  @Test
  public void testRegistroPassSinCarac() throws Exception {
    ...
    driver.findElement(By.id("Input_Password")).sendKeys("Ab123456");
    driver.findElement(By.id("Input_ConfirmPassword")).click();
    driver.findElement(By.id("Input_ConfirmPassword")).clear();
    driver.findElement(By.id("Input_ConfirmPassword")).sendKeys("Ab123456");

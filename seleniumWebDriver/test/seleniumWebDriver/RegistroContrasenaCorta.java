...
public class RegistroContrasenaCorta {
  ...
  @Test
  public void testRegistroContrasenaCorta() throws Exception {
    ...
    driver.findElement(By.id("Input_Password")).sendKeys("12");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Register'])[2]/following::form[1]")).click();
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    assertEquals("The Password must be at least 6 and at max 100 characters long.", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Confirm password'])[1]/preceding::span[1]")).getText());
  }

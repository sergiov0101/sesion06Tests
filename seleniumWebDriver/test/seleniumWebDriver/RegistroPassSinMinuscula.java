...
public class RegistroPassSinMinuscula {
  ...
  @Test
  public void testRegistroPassSinMinuscula() throws Exception {
    ...
    driver.findElement(By.id("Input_Password")).sendKeys("A!123456");
    driver.findElement(By.id("Input_ConfirmPassword")).clear();
    driver.findElement(By.id("Input_ConfirmPassword")).sendKeys("A!123456");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Confirm password'])[1]/following::button[1]")).click();
    assertEquals("Passwords must have at least one lowercase ('a'-'z').", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Create a new account.'])[1]/following::li[1]")).getText());
  }

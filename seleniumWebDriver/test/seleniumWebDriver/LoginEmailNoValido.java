...
public class LoginEmailNoValido {
  ...
  @Test
  public void testLoginEmailNoValido() throws Exception {
    driver.get("https://loginhmis1svo585.azurewebsites.net/Identity/Account/Login");
    driver.findElement(By.id("Input_Email")).click();
    driver.findElement(By.id("Input_Email")).clear();
    driver.findElement(By.id("Input_Email")).sendKeys("usuario");
    driver.findElement(By.id("account")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Password'])[1]/following::button[1]")).click();
    assertEquals("The Email field is not a valid e-mail address.", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='The Password field is required.'])[2]/preceding::span[1]")).getText());

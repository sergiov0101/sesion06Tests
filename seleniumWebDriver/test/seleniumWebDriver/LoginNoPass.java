...
public class LoginNoPass {
  ...
  @Test
  public void testLoginNoPass() throws Exception {
	    ...
	    assertEquals("The Password field is required.", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Use a local account to log in.'])[1]/following::li[1]")).getText());
	    assertEquals("The Password field is required.", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Log in'])[2]/preceding::span[1]")).getText());
	  }

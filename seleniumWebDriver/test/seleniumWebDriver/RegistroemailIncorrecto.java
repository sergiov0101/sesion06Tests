...
public class RegistroemailIncorrecto {
  ...
  @Test
  public void testRegistroemailIncorrecto() throws Exception {
    ...
    assertEquals("The Email field is not a valid e-mail address.", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Confirm password'])[1]/preceding::span[2]")).getText());
  }

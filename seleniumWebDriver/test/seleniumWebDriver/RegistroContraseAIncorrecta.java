...
public class RegistroContraseAIncorrecta {
  ...
  @Test
  public void testRegistroContraseAIncorrecta() throws Exception {
    ...
    driver.findElement(By.id("Input_Password")).sendKeys("1234567");
    driver.findElement(By.id("Input_ConfirmPassword")).click();
    driver.findElement(By.id("Input_ConfirmPassword")).clear();
    driver.findElement(By.id("Input_ConfirmPassword")).sendKeys("1234567");
    ...
    assertEquals("Passwords must have at least one uppercase ('A'-'Z').", driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)=concat('Passwords must have at least one lowercase (', \"'\", 'a', \"'\", '-', \"'\", 'z', \"'\", ').')])[1]/following::li[1]")).getText());
  }
